...
describe('Assistant Chat surface copy', () => {
  ...
  it('keeps expanded Assistant Home chat history in the reserved space above the composer', () => {
    ...
    expect(rendererCss).toContain('--assistant-home-stage-min-width: 72.375rem;')
    expect(rendererCss).toContain('--assistant-home-stage-max-width: 80.375rem;')
  ...
  it('renders CoBrowse inside the Assistant Home surface instead of the work-mode dock', () => {
    ...
    expect(rendererCss).toContain('.assistant-home-cobrowse-shell .assistant-home-stage')
    expect(rendererCss).toContain('max-width: 100% !important;')
